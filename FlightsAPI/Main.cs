/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘FlightsAPI.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.dataSourceNameToDataSource.Add("Flights_REST!Output", _flow.DataFetchActivity11);
            ...
            _flow.dataSourceNameToDataSource.Add("Flights_REST!Input", _flow.DataFetchActivity8);
            ...
            _flow.RESTActivityV26.Url = @"http://localhost:8000/Flights_REST/FlightOrders";
...
<FlightOrderDetails xmlns=""HP.SOAQ.SampleApp"">
  <DepartureCity>{DataSource.Flights_REST!Input.DepartureCity}</DepartureCity>
  <ArrivalCity>{DataSource.Flights_REST!Input.ArrivalCity}</ArrivalCity>	
...
@"<RequestMultipartInfo><Type>Related</Type></RequestMultipartInfo>");
            ...
            _flow.RESTActivityV26.InDirections.Add(bind_dir6);
            ...
            _flow.RESTActivityV26.InDirections.Add(bind_dir7);
            ...
            _flow.RESTActivityV26.InDirections.Add(bind_dir8);
            VTDPropertyInfoBase pi17 = new VTDPropertyInfoBase("DepartureCity");
            VTDBaseGetter binding_getter9 = new VTDObjectGetter(pi17);
            VTDPropertyInfoBase pi18 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='FlightOrderDetails'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter9 = new VTDXPathSetter(pi18,XmlTypeCode.String);
            binding_setter9 = new StringFormaterDecorator(binding_setter9,"{DataSource.Flights_REST!Input.DepartureCity}");
            bind_dir9 = new BindDirection(this.DataCursorActivity15,binding_getter9,binding_setter9,BindTargetType.ToInProperty);
            _flow.RESTActivityV26.InDirections.Add(bind_dir9);
            VTDPropertyInfoBase pi19 = new VTDPropertyInfoBase("CustomerName");
            VTDBaseGetter binding_getter10 = new VTDObjectGetter(pi19);
            VTDPropertyInfoBase pi20 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='FlightOrderDetails'][1]/*[local-name(.)='CustomerName'][1]");
            VTDBaseSetter binding_setter10 = new VTDXPathSetter(pi20,XmlTypeCode.String);
            binding_setter10 = new StringFormaterDecorator(binding_setter10,"{DataSource.Flights_REST!Input.CustomerName}");
            bind_dir10 = new BindDirection(this.DataCursorActivity15,binding_getter10,binding_setter10,BindTargetType.ToInProperty);
            _flow.RESTActivityV26.InDirections.Add(bind_dir10);
            VTDPropertyInfoBase pi21 = new VTDPropertyInfoBase("Class");
            VTDBaseGetter binding_getter11 = new VTDObjectGetter(pi21);
            VTDPropertyInfoBase pi22 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='FlightOrderDetails'][1]/*[local-name(.)='Class'][1]");
            VTDBaseSetter binding_setter11 = new VTDXPathSetter(pi22,XmlTypeCode.String);
            binding_setter11 = new StringFormaterDecorator(binding_setter11,"{DataSource.Flights_REST!Input.Class}");
            bind_dir11 = new BindDirection(this.DataCursorActivity15,binding_getter11,binding_setter11,BindTargetType.ToInProperty);
            _flow.RESTActivityV26.InDirections.Add(bind_dir11);
            VTDPropertyInfoBase pi23 = new VTDPropertyInfoBase("ArrivalCity");
            VTDBaseGetter binding_getter12 = new VTDObjectGetter(pi23);
            VTDPropertyInfoBase pi24 = new VTDPropertyInfoBase("XMLBody","/*[local-name(.)='FlightOrderDetails'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter12 = new VTDXPathSetter(pi24,XmlTypeCode.String);
            binding_setter12 = new StringFormaterDecorator(binding_setter12,"{DataSource.Flights_REST!Input.ArrivalCity}");
            bind_dir12 = new BindDirection(this.DataCursorActivity15,binding_getter12,binding_setter12,BindTargetType.ToInProperty);
            _flow.RESTActivityV26.InDirections.Add(bind_dir12);
